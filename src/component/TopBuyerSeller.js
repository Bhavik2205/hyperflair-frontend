                            ...
                            <div className='d-flex align-items-center'>
                                <div className='d-flex align-items-center'>
                                    ...
                                    <div className="main__filter-wrap">
                                        <Select defaultValue={{ label: "buyer", value: 0 }} styles={styles} onChange={setSelectedOption} options={options} isSearchable={false} isFocused={false} className="cust-select" />
                                    </div>
                                </div>
                                <div className='d-flex align-items-center'>
                                    <h2>&nbsp;in</h2>
                                    <div className="main__filter-wrap">
                                        <Select defaultValue={{ label: "1 day", value: 0 }} styles={styles} onChange={setSelectedOption} options={optionstwo} isSearchable={false} isFocused={false} className="cust-select" />
                                    </div>
                                </div>
                            </div>
