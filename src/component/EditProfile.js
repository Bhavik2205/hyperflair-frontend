								...
								<div className="author__meta">
									<form className="sign__form sign__form--profile mt-0">
										<div className="sign__group">
											...
											<input id="username" type="text" name="username" className="sign__input" placeholder="Enter your display name" value={name} onChange={(event)=>setName(event.target.value)}/>
										</div>
										<div className='sign__group'>
											<label className="sign__label required-field" htmlFor="short-bio">Short Bio</label>
											<textarea id="short-bio" name="short-bio" className="sign__textarea" placeholder="Tell about yourself in a few words" value={bio} onChange={(event)=>setBio(event.target.value)}></textarea>
										</div>
										<div className="sign__group">
											<label className="sign__label" htmlFor="email">Email Address</label>
											<input id="email" type="text" name="email" className="sign__input" placeholder="Enter your email" value={email} onChange={(event)=>setEmail(event.target.value)} />
										</div>
										...
										<div className="sign__group">
											...
											<input id="twitter" type="text" name="twitter" className="sign__input" placeholder="Enter your Twitter Link" value={twitter} onChange={(event)=>setTwitter(event.target.value)}/>
										</div>
										<div className="sign__group">
											<label className="sign__label" htmlFor="instagram">Instagram Link</label>
											<input id="instagram" type="text" name="instagram" className="sign__input" placeholder="Enter your Instagram Link" value={instagram} onChange={(event)=>setInstagram(event.target.value)}/>
										</div>
										<div className="sign__group">
											<label className="sign__label" htmlFor="sitelink">Personal site or portfolio</label>
											<input id="sitelink" type="text" name="sitelink" className="sign__input" placeholder="https://yoursitelink.com" value={website} onChange={(event)=>setWebsite(event.target.value)}/>
										</div>
