...
const CreateItem = () => {
  ...
  const handleTransactionShow=()=>{setTransactionShow(true)}
     ...
     const createNFT=async()=>{
      ...
      try{
        ...
        const transformItems = (itemsObj) => {
          ...
          const res=await fetch(`${process.env.REACT_APP_IMG_SERVER}/api/nft/create`,data,{
            method:'POST',
            }
          )
            console.log(res)
          ...
          <div className="col-12 col-lg-9">
            ...
            <form className="sign__form sign__form--create">
              ...
              <div className="w-100 unlock-switch">
                ...
                <div className="sign__group unlock-textarea mt-2 mb-0">
                  <textarea
                    ...
                    className="sign__textarea mb-0"
                    placeholder="Enter content (access key, code to redeem, link to a file, etc.)"
                    value={unlockableContent}
                    onChange={()=>setUnlockableContent(!unlockableContent)}
                  ></textarea>
                </div>
              </div>
              <div className="asset--form">
              ...
              <div className="sign__group mt-3">
                <label className="sign__label required-field" htmlFor="supplay">
                  Supply
                </label>
                <p className="f-12 f-500">
